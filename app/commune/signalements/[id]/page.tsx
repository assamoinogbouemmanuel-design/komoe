...
export default function SignalementDetailPage() {
  ...
  return (
    <div className="animate-in fade-in duration-500 max-w-4xl mx-auto pb-12">
      <Link href="/commune/signalements" className="inline-flex items-center text-sm font-bold text-muted-foreground hover:text-brand-blue mb-6">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h2 className="text-3xl font-extrabold text-foreground tracking-tight">Nid de poule dangereux ({id})</h2>
            <Badge variant="secondary">En cours</Badge>
          </div>
          <p className="text-muted-foreground font-medium text-sm flex items-center gap-4 mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="shadow-sm border-border rounded-3xl">
          <CardContent className="p-6">
            ...
            <div className="mt-6 pt-6 border-t border-border">
              <h4 className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-3">Citoyen Signalant</h4>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-muted/50 rounded-full flex items-center justify-center text-muted-foreground"><Users size={18} /></div>
                <div>
                  <p className="font-bold text-foreground text-sm">Kouadio Jean</p>
        ...
        <Card className="shadow-sm border-border rounded-3xl">
          <CardContent className="p-6">
            <h3 className="text-lg font-bold text-foreground mb-4">Photos jointes</h3>
            <div className="grid grid-cols-2 gap-3">
              <div className="aspect-square bg-muted/50 rounded-2xl flex items-center justify-center border border-border">
